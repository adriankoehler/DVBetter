<template>
  <q-page>
    <div class="content-wrapper">
      <h1>
        Connection from {{ stationIdOrigin }} to {{ stationIdDestination }}
      </h1>
      <h2>Connections:</h2>
...
const stationIdDestination = connectionId.substring(
  connectionId.indexOf("-") + 1
);

if (connectionId) {
  api
    .post("/tr/trips?format=json", {
